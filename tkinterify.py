...
def tkinterify(cli_group, app_name="Network App"):
            ...
            try:
                ...
                if command_name in command_name_list:
                    try:
                        ...
                        context = available_commands[command_name].make_context(
                            "tkinter", [' '.join(command_args)]if len(command_args) else [])
    ...
    button_clear = tkinter.Button(root, text="Help", command=clear_callback)
